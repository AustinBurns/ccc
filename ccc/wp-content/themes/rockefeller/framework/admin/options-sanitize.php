...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', THE_LANG),
		'repeat-x'  => __('Repeat Horizontally', THE_LANG),
		'repeat-y'  => __('Repeat Vertically', THE_LANG),
		'repeat'    => __('Repeat All', THE_LANG)
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', THE_LANG),
		'top center'    => __('Top Center', THE_LANG),
		'top right'     => __('Top Right', THE_LANG),
		'center left'   => __('Middle Left', THE_LANG),
		'center center' => __('Middle Center', THE_LANG),
		'center right'  => __('Middle Right', THE_LANG),
		'bottom left'   => __('Bottom Left', THE_LANG),
		'bottom center' => __('Bottom Center', THE_LANG),
		'bottom right'  => __('Bottom Right', THE_LANG)
		);
...
function of_recognized_font_styles() {
	$default = array(
		...
		'italic'      => __('Italic', THE_LANG),
		'bold'        => __('Bold', THE_LANG),
		'bold italic' => __('Bold Italic', THE_LANG)
		);
...
function of_sanitize_selecttext( $input, $option  ) {
	$output = wp_parse_args( $input, array(
		'select' => '',
		'text'  => ''
	) );
	$output['select'] = apply_filters( 'of_sanitize_enum', $input['select'], $option['options'] );
	$output['text'] = apply_filters( 'sanitize_text_field', $input['text'] );

	return $output;
}
add_filter( 'of_sanitize_selecttext', 'of_sanitize_selecttext', 10, 2 );