...
?>
    ...
    <div id="optionsframework" class="postbox">
        ...
        <div id="optionsframework-submit">
			<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', THE_LANG ); ?>" />
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', THE_LANG ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', THE_LANG ) ); ?>' );" />
            <div class="clear"></div>
		</div>
	</form>
</div> <!-- / #container -->
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', THE_LANG ), 'updated fade' );
	...
	if ( isset( $_POST['update'] ) ) {
		...
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', THE_LANG ), 'updated fade' );
		return $clean;
	}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Theme Options', THE_LANG ),
...
if ( ! function_exists( 'if_get_option' ) ) {
	...
	/**
	 * Interfeis Get Option.
	 */
	 
	function if_get_option( $name, $default = false ) {
