...
define( 'NOTIFIER_THEME_NAME', 'Immersion' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'immersion' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://pixelthemes.net/notifiers/immersion/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
